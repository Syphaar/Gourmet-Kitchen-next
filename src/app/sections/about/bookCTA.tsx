    ...
    <section className="relative py-12 md:py-14 xl:py-16 bg-white overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center px-6">
        <h3 className="text-3xl sm:text-4xl xl:text-5xl font-serif font-extrabold text-gray-900 mb-4 tracking-tight">
          Reserve A 
          <span className="text-[#C9A227]"> Table </span>
        </h3>
        <p className="text-lg mb-8 leading-relaxed">
          Ready for a great meal? Pick a time, click the button below, and let us save your spot.  
          We&apos;ll have your table ready for an effortless, delicious experience.
        </p>
